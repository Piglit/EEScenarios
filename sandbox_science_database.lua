...
--	Phobos T2
	...
	phobos_t2_db:setLongDescription("Based on Phobos M3P with these differences: more repair crew, a jump drive, faster spin, stronger front shield, weaker rear shield, less maximum energy, turreted and faster beams, one more tube forward, and fewer missiles\n\n")
	phobos_t2_db:setKeyValue("Class","Frigate")
	phobos_t2_db:setKeyValue("Sub-class","Cruiser")
	phobos_t2_db:setKeyValue("Deployed Callsign","Ambition")
	...
	phobos_t2_db:setKeyValue("Small Tube 0","10 sec / HVLI")
	phobos_t2_db:setKeyValue(" Small Tube 0","10 sec / HVLI")
	phobos_t2_db:setKeyValue("Tube 0","15 sec / HVLI, Homing, Nuke, EMP")
...
--	Phobos T2.2
	frigate_prototype_db:addEntry("Phobos T2.2")
	local phobos_t2_db = queryScienceDatabase("Ships","Prototype","Frigate","Phobos T2.2")
	...
	phobos_t2_db:setKeyValue("Class","Frigate")
	phobos_t2_db:setKeyValue("Sub-class","Cruiser")
	phobos_t2_db:setKeyValue("Deployed Callsigns","Nimbus, Terror")
	phobos_t2_db:setKeyValue("Size","80")
	phobos_t2_db:setKeyValue("Shield","120/80")
	phobos_t2_db:setKeyValue("Hull","200")
	phobos_t2_db:setKeyValue("Repair Crew",4)
	...
	phobos_t2_db:setKeyValue("Beam weapon 330:40","Rng:1.2 Dmg:6 Cyc:4 Tur:.2")
	phobos_t2_db:setKeyValue("Beam weapon 30:40","Rng:1.2 Dmg:6 Cyc:4 Tur:.2")
	phobos_t2_db:setKeyValue("Tube 0","10 sec / HVLI, Homing, Nuke, EMP")
	phobos_t2_db:setKeyValue("Tube 180","10 sec / Mine")
	phobos_t2_db:setKeyValue("Storage Homing",8)
	phobos_t2_db:setKeyValue("Storage Nuke",2)
	phobos_t2_db:setKeyValue("Storage Mine",4)
...
--	Midian
	corvette_prototype_db:addEntry("Midian")
	local midian_db = queryScienceDatabase("Ships","Prototype","Corvette","Midian")
	midian_db:setLongDescription("Loosely based on the missile cruiser with a different exterior profile: slow warp drive, two forward beam weapons and one turreted rear beam weapon, slightly angled small front tubes for homing missiles and HVLIs, single broadside tube on each side, fewer homing, nuke, EMP, mine and added HVLI.\n\nDeployed Mar2020 as Simian for 3 missions. Deployed as Knuckle Drag Nov2020 for 1 mission. Deployed as Knuckle Drag May2021 for 1 mission.\n\nFlipper deployed Jun2021 and Oct2021.")
	midian_db:setKeyValue("Class","Corvette")
	midian_db:setKeyValue("Deployed Callsign","Flipper")
	midian_db:setKeyValue("Size","100")
	midian_db:setKeyValue("Shield","110/70")
	midian_db:setKeyValue("Hull","200")
	midian_db:setKeyValue("Repair Crew",3)
	midian_db:setKeyValue("Warp Speed","48.0 U/min")	--800
	midian_db:setKeyValue("Sensor Ranges","Long: 25 U / Short: 5.5 U")
	midian_db:setKeyValue("Move speed","3.6 U/min")	--60
	midian_db:setKeyValue("Turn speed","8 deg/sec")
	midian_db:setKeyValue("Beam weapon 340:50","Rng:1 Dmg:4 Cyc:6")
	midian_db:setKeyValue("Beam weapon  20:50","Rng:1 Dmg:4 Cyc:6")
	midian_db:setKeyValue("Beam weapon 180:220","Rng:1 Dmg:2 Cyc:6 Tur:.3")
	midian_db:setKeyValue("Small Tube 358","8 sec / HVLI, Homing")
	midian_db:setKeyValue("Small Tube 2","8 sec / HVLI, Homing")
	midian_db:setKeyValue("Tube 270","12 sec / HVLI, EMP, Nuke")
	midian_db:setKeyValue("Tube 90","12 sec / HVLI, EMP, Nuke")
	midian_db:setKeyValue("Tube 180","15 sec / Mine")
	midian_db:setKeyValue("Storage Homing",16)
	midian_db:setKeyValue("Storage Nuke",2)
	midian_db:setKeyValue("Storage EMP",5)
	midian_db:setKeyValue("Storage Mine",5)
	midian_db:setKeyValue("Storage HVLI",16)
	midian_db:setImage("cruiser.png")
	midian_db:setModelDataName("space_cruiser_4")
--	Noble
...
--	Proto-Atlantis
	...
	proto_atlantis_db:setKeyValue("Deployed Callsigns","Gorn, Halberd")
...
--	Proto-Atlantis 2
	corvette_prototype_db:addEntry("Proto-Atlantis 2")
	local proto_atlantis_db = queryScienceDatabase("Ships","Prototype","Corvette","Proto-Atlantis 2")
	proto_atlantis_db:setLongDescription("Atlantis predecessor: more repair crew, shorter jump drive range, hotter and more inefficient beams, fewer missile types, dedicated tubes for Homing and HVLI left and right, and shorter short range sensors\n\n")
	proto_atlantis_db:setKeyValue("Class","Corvette")
	proto_atlantis_db:setKeyValue("Sub-class","Destroyer")
	...
	proto_atlantis_db:setKeyValue("Beam weapon 340:100","Rng:1.5 Dmg:8 Cyc:6")
	proto_atlantis_db:setKeyValue("Beam weapon 20:100","Rng:1.5 Dmg:8 Cyc:6")
	proto_atlantis_db:setKeyValue("Tube 0","8 sec / HVLI")
	proto_atlantis_db:setKeyValue("Tube 270","8 sec / HVLI")
	proto_atlantis_db:setKeyValue(" Tube 270","8 sec / Homing")
	proto_atlantis_db:setKeyValue("Tube 90","8 sec / HVLI")
	proto_atlantis_db:setKeyValue(" Tube 90","8 sec / Homing")
